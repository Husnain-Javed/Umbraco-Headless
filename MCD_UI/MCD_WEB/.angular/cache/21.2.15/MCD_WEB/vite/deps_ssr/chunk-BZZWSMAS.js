...
import {
  ...
  Router,
  loadChildren
} from "./chunk-BWBV2DK5.js";
import {
  BrowserDomAdapter,
  BrowserModule,
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin
} from "./chunk-2G4DTEF5.js";
import {
  HTTP_ROOT_INTERCEPTOR_FNS
} from "./chunk-NGDOTH3L.js";
import {
  index
...
import {
  ...
  PLATFORM_SERVER_ID,
  ViewportScroller
} from "./chunk-2DY5HVSE.js";
import {
  PlatformLocation,
  XhrFactory,
  getDOM,
  setRootDomAdapter
} from "./chunk-2INKITRG.js";
import {
  APP_ID,
  ApplicationRef,
  CSP_NONCE,
...
function _document() {
  ...
  if (config && config.document) {
    document2 = typeof config.document === "string" ? _enableDomEmulation ? parseDocument(config.document, config.url !== void 0 ? resolveUrl(config.url, "http://localhost").href : void 0) : window.document : config.document;
  } else {
...
//# sourceMappingURL=chunk-BZZWSMAS.js.map
